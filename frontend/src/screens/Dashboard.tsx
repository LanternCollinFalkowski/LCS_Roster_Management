        ...
        {isLoading || !data ? (
          ...
          <>
            ...
            <div className="mb-5 grid grid-cols-2 gap-3 md:grid-cols-4">
              ...
              <Tile icon={Layers} label="To review" value={data.totals.attention} tone={data.totals.attention ? "amber" : undefined} to={`/review${param ? `?site=${param}` : ""}`} />
            ...
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)]">
              ...
              <Card className="page-list-item-enter p-4" style={{ animationDelay: "50ms" }}>
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <Link to="/activity" className="text-[12.5px] font-semibold text-accent dark:text-white">All activity</Link>
                </div>
