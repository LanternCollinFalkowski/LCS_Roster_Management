...
export const env = {
  ...
  corsOrigins: list(process.env.CORS_ORIGIN, "http://localhost:5273"),
  ...
  microsoft: {
    ...
    redirectUri:
      process.env.MICROSOFT_REDIRECT_URI ?? "http://localhost:5273/api/auth/microsoft/callback",
  },
...
export const appBaseUrl = env.appBaseUrl || env.corsOrigins[0] || "http://localhost:5273";
